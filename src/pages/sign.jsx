...
export default function SignPage({ isSignIn }) {
    ...
    useEffect(function () {
        if (isSignIn) setRandom(Math.round(getRandomArbitrary(1000, 9999)))
    }, [isSignIn])
        ...
        <section className="bg-[#302aaf] text-white h-screen flex flex-col justify-center items-center">
            ...
            <form action="#" className="w-2/4">
                <div className="flex flex-col items-start w-full justiy-center">
                    ...
                    <input type="number" name="Mobile" id="Mobile" placeholder="+234..." className="block w-full p-1 mt-1 mb-3 rounded indent-4" />
                </div>
                <div className="flex flex-col items-start w-full justiy-center">
                    <label htmlFor="Password">Password</label>
                    <input type="password" name="Password" id="Password" placeholder="******" className="block w-full p-1 mt-1 mb-3 rounded indent-4" />
                </div>
                {!isSignIn && <>
                    <div className="flex flex-col items-start w-full justiy-center">
                        <label htmlFor="Confirmpassword">Confirm password</label>
                        <input type="password" name="Confirmpassword" id="Confirmpassword" placeholder="******" className="block w-full p-1 mt-1 mb-3 rounded indent-4" />
                    </div>
                    <div className="flex flex-col items-start w-full justiy-center">
                        <label htmlFor="Invitation_code">Invitation code (option)</label>
                        <input type="text" name="Invitation_code" id="Invitation_code" placeholder="Ze4E88" className="block w-full p-1 mt-1 mb-3 rounded indent-4" />
                    </div>
                    <div className="flex flex-row items-start w-full gap-1 justiy-between">
                        <div className="flex flex-col items-start w-3/4 justiy-center">
                            ...
                            <input type="text" name="Verifiaion_code" id="Verifiaion_code" placeholder="????" className="block w-full p-1 mt-1 mb-3 rounded indent-4" />
                        </div>
