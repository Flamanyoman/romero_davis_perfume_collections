            ...
            <div className={`!bg-[url('/imgs/homeimage_desktop.webp')] bg-cover bg-left-top bg-fixed h-[40vh]`}>
                <div className="container flex flex-col items-center justify-between !text-[white] !font-bold h-full pt-4 pb-2">
                    ...
                    <div className='flex flex-col items-center justify-center'>
                        ...
                        <p to="/send_receipt" className="block px-4 py-2 mt-2 rounded">Customer service time online</p>
                    </div>
                    <p className='container'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Minima, doloremque?</p>
                </div>
            </div>
